...
Mismatch = make_struct("Mismatch", [("expected", "iroha_core.smartcontracts.isi.permissions.ValidatorType"), ("actual", "iroha_core.smartcontracts.isi.permissions.ValidatorType")])
